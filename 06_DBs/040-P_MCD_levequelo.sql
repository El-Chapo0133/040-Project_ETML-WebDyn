...
INSERT INTO t_categoryDish (catCategory, idCategoryDishes) VALUES ('Viandes', '1');
INSERT INTO t_categoryDish (catCategory, idCategoryDishes) VALUES ('Salades', '2');
INSERT INTO t_categoryDish (catCategory, idCategoryDishes) VALUES ('Desserts', '3');
...
INSERT INTO t_dish (disName, disPeopleAmount, disDifficulty, disIngridients, disRecepy, disImage, disCreationDate, idDishes, idUSer) VALUES ('Salade Cesar au Poulet', '2', '1', '200 g de feuilles de laitue
     ...
     1 grossse poignée de croûtons de pain
     60 g de copeaux de parmesan
     1 gousse d\'ail
     le jus d\'un citron
     5 cl de sauce tartare
     sel, poivre', 'Nettoyez et essorez la laitue.
     Découpez les blancs de poulet en morceaux.
     Pelez et hachez l\'ail.
     Mélangez dans un saladier la sauce tartare, le jus de citron, l\'ail, du sel et du poivre.
     Ajoutez la laitue, le poulet, les copeaux de parmesan, les croûtons de pain et mélangez bien.
     Réservez au frais jusqu\'au service.', '../../00_Resources/01_Images/01_Dishes/SaladeCesar_Poulet.jpg', '2019-04-08', '1', '1');
...
Dans un autre bol, ajouter du lait et un œuf et mélanger. Y incorporer le poulet, puis le tremper dans le mélange de farine et d’épices. Faire frire le poulet dans la poêle pendant 10 à 15 minutes. Laisser un peu refroidir avant de déguster.', '../../00_resources/01_images/01_Dishes/PouletKFC.jpg', '2019-04-08', '3', '2');
